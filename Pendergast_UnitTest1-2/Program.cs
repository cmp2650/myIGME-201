...
namespace NumberSort
{
    class Program
    {
        ...
        start:
            ...
            // a string used for parsing the current array element
            string nThisNumber;
            ...
            foreach (string sThisNumber in sNumber)
            {
                ...
                try
                {
                    // try to parse the current string into a string
            ...
            foreach (string sThisNumber in sNumber)
            {
                ...
                // parse it into a string (we know they are all valid now)
                nThisNumber = sThisNumber;
        ...
        static string FindLowestValue(string[] array)
        {
            ...
            foreach (string thisNum in array)
            {
                ...
                if (String.Compare(thisNum, returnVal) < 0)
                {
